...
class HelicopterLeft(pygame.sprite.Sprite):
    first_image = pygame.image.load("Sprites/helicopter_left_1.png")
    second_image = pygame.image.load("Sprites/helicopter_left_2.png")
    third_image = pygame.image.load("Sprites/helicopter_left_3.png")
